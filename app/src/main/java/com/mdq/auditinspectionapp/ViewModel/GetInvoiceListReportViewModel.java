...
public class GetInvoiceListReportViewModel extends InvoiceRequestBaseViewModel implements InvoiceRequestInterface {
    private InvoiceDataManger invoiceDataManger;
    private InvoiceResponseInterface invoiceResponseInterface;
    private Context mContext;

    public GetInvoiceListReportViewModel(Context mContext, InvoiceResponseInterface invoiceResponseInterface) {
