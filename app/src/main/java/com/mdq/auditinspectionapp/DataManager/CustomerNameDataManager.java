...
public class CustomerNameDataManager {
    private final String TAG = CustomerNameDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public CustomerNameDataManager(Context context) {
    ...
    public void callEnqueue(String url, String auth, final ResponseHandler<CustomerNameResponseModel> dataresponse) {
        ...
        userMpinCall.enqueue(new Callback<CustomerNameResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<CustomerNameResponseModel> call, Response<CustomerNameResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<CustomerNameResponseModel> call, Throwable t) {
