...
public class FinalInvoiceDataManager {

    private final String TAG = FinalInvoiceDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public FinalInvoiceDataManager(Context context) {
    ...
    public void callEnqueue(String url, GenerateFinalInvoiceRequestModel generateFinalInvoiceRequestModel, final ResponseHandler<GenerateFinalInvoiceResponseModel> dataresponse) {
        ...
        userMpinCall.enqueue(new Callback<GenerateFinalInvoiceResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GenerateFinalInvoiceResponseModel> call, Response<GenerateFinalInvoiceResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<GenerateFinalInvoiceResponseModel> call, Throwable t) {
