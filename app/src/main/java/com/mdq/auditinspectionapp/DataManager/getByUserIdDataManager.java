...
public class getByUserIdDataManager {

    private final String TAG = getByUserIdDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public getByUserIdDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, String auth, getByUserIDRequestModel getByUserIDRequestModel, final ResponseHandler<getByUserIDResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<getByUserIDResponseModel> userMpinCall = apiInterface.getByUSERID(url,auth, getByUserIDRequestModel);
        userMpinCall.enqueue(new Callback<getByUserIDResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<getByUserIDResponseModel> call, Response<getByUserIDResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<getByUserIDResponseModel> call, Throwable t) {
