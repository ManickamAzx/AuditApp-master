...
public class SourceDataManager {
    private final String TAG = SourceDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public SourceDataManager(Context context) {
    ...
    public void callEnqueue(String url, String Authorization, final ResponseHandler<GenerateSourceResponseModel> dataresponse) {
        ...
        UserCall.enqueue(new Callback<GenerateSourceResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GenerateSourceResponseModel> call, Response<GenerateSourceResponseModel> response) {
                /**
