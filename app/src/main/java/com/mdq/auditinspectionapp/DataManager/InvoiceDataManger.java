...
public class InvoiceDataManger {
    private final String TAG = InvoiceDataManger.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public InvoiceDataManger(Context context) {
    ...
    public void callEnqueue(String url, String auth, GenerateInvoiceRequestModel generateInvoiceRequestModel, final ResponseHandler<GenerateInvoiceResponseModel> dataresponse) {
        ...
        Call<GenerateInvoiceResponseModel> userMpinCall = apiInterface.generateGetInvoiceCall(url, auth, generateInvoiceRequestModel);
