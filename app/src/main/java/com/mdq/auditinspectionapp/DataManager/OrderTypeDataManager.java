...
public class OrderTypeDataManager {
    private final String TAG = OrderTypeDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public OrderTypeDataManager(Context context) {
    ...
    public void callEnqueue(String url, OrderTypeRequestModel orderTypeRequestModel, String auth, final ResponseHandler<OrderTypeResponseModel> dataresponse) {
        ...
        userMpinCall.enqueue(new Callback<OrderTypeResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<OrderTypeResponseModel> call, Response<OrderTypeResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<OrderTypeResponseModel> call, Throwable t) {
