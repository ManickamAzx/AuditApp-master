...
public class BrandDataManager {
    private final String TAG = BrandDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public BrandDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, String auth, GenerateBrandRequestModel generateBrandRequestModel, final ResponseHandler<GenerateBrandResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<GenerateBrandResponseModel> userMpinCall = apiInterface.generateGetBrandCall(url, auth, generateBrandRequestModel);
        userMpinCall.enqueue(new Callback<GenerateBrandResponseModel>() {
             ...
             */
            @Override
            public void onFailure(Call<GenerateBrandResponseModel> call, Throwable t) {
