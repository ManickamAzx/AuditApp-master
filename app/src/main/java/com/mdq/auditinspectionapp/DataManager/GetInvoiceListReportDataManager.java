...
public class GetInvoiceListReportDataManager {
    private final String TAG = GetInvoiceListReportDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public GetInvoiceListReportDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, String auth, GenerateInvoiceRequestModel generateInvoiceRequestModel, final ResponseHandler<GenerateInvoiceResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<GenerateInvoiceResponseModel> userMpinCall = apiInterface.generateGetInvoiceListReportCall(url, auth, generateInvoiceRequestModel);
        userMpinCall.enqueue(new Callback<GenerateInvoiceResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GenerateInvoiceResponseModel> call, Response<GenerateInvoiceResponseModel> response) {
                /**
